...
//   const developers = useSelector(getUsersSelector, isEqual)
...
//     const currentActiveProjectDevelopers = currentProjectDevelopers.filter(
//       (dev) => dev.is_active === true
//     )
//     const currentActiveProjectDevelopersIdArray =
//       currentActiveProjectDevelopers.map((dev) => dev.user_id)
//     availableDevelopers =
//       developers.filter(
//         (dev) => !currentActiveProjectDevelopersIdArray.includes(dev.id)
//       ) || null
//   }
//   if (type === 'create') {
//     const selectedDevId = values?.team.map((el) => el.user_id)
//     availableDevelopers = developers.filter(
//       (dev) => !selectedDevId.includes(dev.id)
//     )
//   }
//
...
//     availableDevelopers = availableDevelopers.filter(
//       (dev) => dev?.name !== data
//     )
//   }
//   return (
