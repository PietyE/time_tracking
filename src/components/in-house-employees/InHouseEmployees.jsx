...
import DropDownCurrencyChange from './components/DropDownCurrencyChange';
...
import WindowUserInfo from './components/WindowUserInfo';
...
function InHouseEmployees () {
  ...
  return (
    <InHouseEmployeesContext.Provider value={{selected,
                                              opened,
                                              currentUserId,
                                              commentsOn,
                                              check, 
