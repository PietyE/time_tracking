...
export enum DeveloperProjectsPermissions {
  ...
  projects_view_developerprojectchangestatus = 'projects.view_developerprojectchangestatus',
  ...
  projects_delete_developerprojectchangestatus = 'projects.delete_developerprojectchangestatus',
  projects_change_developerproject = 'projects.change_developerproject',
  projects_add_developerprojectchangestatus = 'projects.add_developerprojectchangestatus',
  projects_change_developerprojectchangestatus = 'projects.change_developerprojectchangestatus',
}
...
export enum VilmatesCommentsPermissions {
  vilmate_comments_delete_vilmatecomment = 'vilmate_comments.delete_vilmatecomment',
  vilmate_comments_add_vilmatecomment = 'vilmate_comments.add_vilmatecomment',
  vilmate_comments_change_vilmatecomment = 'vilmate_comments.change_vilmatecomment',
...
export enum SystemPermissions {
  ...
  django_celery_beat_add_crontabschedule = 'django_celery_beat.add_crontabschedule',
  ...
  django_celery_beat_delete_intervalschedule = 'django_celery_beat.delete_intervalschedule',
  django_celery_beat_change_periodictask = 'django_celery_beat.change_periodictask',
  ...
  django_celery_beat_delete_periodictasks = 'django_celery_beat.delete_periodictasks',
  contenttypes_view_contenttype = 'contenttypes.view_contenttype',
  django_celery_beat_view_intervalschedule = 'django_celery_beat.view_intervalschedule',
  history_view_historyfield = 'history.view_historyfield',
  django_celery_beat_view_clockedschedule = 'django_celery_beat.view_clockedschedule',
  auth_add_permission = 'auth.add_permission',
  django_celery_beat_delete_solarschedule = 'django_celery_beat.delete_solarschedule',
  ...
  django_celery_beat_view_solarschedule = 'django_celery_beat.view_solarschedule',
  ...
  django_celery_beat_change_intervalschedule = 'django_celery_beat.change_intervalschedule',
  ...
  django_celery_beat_add_intervalschedule = 'django_celery_beat.add_intervalschedule',
  ...
  django_celery_beat_delete_periodictask = 'django_celery_beat.delete_periodictask',
  django_celery_beat_change_periodictasks = 'django_celery_beat.change_periodictasks',
  money_view_currency = 'money.view_currency',
  django_celery_beat_delete_crontabschedule = 'django_celery_beat.delete_crontabschedule',
  django_celery_beat_change_solarschedule = 'django_celery_beat.change_solarschedule',
  django_celery_beat_add_periodictasks = 'django_celery_beat.add_periodictasks',
  django_celery_beat_view_periodictasks = 'django_celery_beat.view_periodictasks',
  django_celery_beat_change_crontabschedule = 'django_celery_beat.change_crontabschedule',
  django_celery_beat_view_crontabschedule = 'django_celery_beat.view_crontabschedule',
  django_celery_beat_change_clockedschedule = 'django_celery_beat.change_clockedschedule',
  auth_view_permission = 'auth.view_permission',
  django_celery_beat_add_clockedschedule = 'django_celery_beat.add_clockedschedule',
  django_celery_beat_delete_clockedschedule = 'django_celery_beat.delete_clockedschedule',
